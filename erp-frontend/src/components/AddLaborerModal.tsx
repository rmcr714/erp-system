              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-2">
                    ...
                    <input type="text" className="w-full bg-white/5 border border-border-subtle p-3 rounded-xl outline-none" placeholder="e.g. 5'8\" />
                  </div>
                  <div className="space-y-2">
          ...
          <section className="py-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="md:col-span-2 space-y-2">
                <label className="text-sm font-medium text-accent-secondary font-bold">Photo URL</label>
                <input
                  type="text"
                  className="w-full bg-white/5 border border-accent-secondary/30 p-3 rounded-xl focus:border-accent-secondary outline-none transition-all"
                  placeholder="Paste image URL here for preview..."
                  onChange={(e) => handleInputChange('photoUrl', e.target.value)}
                />
                <p className="text-[10px] text-text-secondary italic">Note: The system will generate a GR number automatically based on designation after registration.</p>
              </div>

              <div className="flex flex-col items-center justify-center p-4 rounded-2xl border-2 border-dashed border-border-subtle bg-black/20 overflow-hidden min-h-[140px]">
                {formData.photoUrl ? (
                  <img
                  ...
                  <div className="text-center">
                    ...
                    <span className="text-[10px] uppercase font-bold text-text-secondary tracking-widest">No Image Provided</span>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <select
                    className="bg-white/5 border border-border-subtle p-3 rounded-xl outline-none"
